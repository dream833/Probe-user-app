      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Obx(() => eshopController.cartLabTest.isEmpty
                ? Container()
                : const Padding(
            ...
            Obx(
              () => ListView.builder(
                ...
                itemCount: eshopController.cartLabTest.length,
                itemBuilder: (context, index) {
                  LabTestModel? labTest = eshopController.cartLabTest[index];
            ...
            Obx(
              () => ListView.builder(
                ...
                scrollDirection: Axis.vertical,
                physics: const ScrollPhysics(),
                itemCount: eshopController.products.values.toList().length,
                itemBuilder: (context, index) {
                  final medicine =
                      eshopController.products.values.toList()[index].first;
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: () {
                                    eshopController.decreaseQuantity(medicine);
                                  },
                                  child: Padding(
                                ...
                                Text(
                                  medicine.selectedQuantity.toString(),
                                  style: const TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w500),
                                ),
                                ...
                                InkWell(
                                  onTap: () {
                                    eshopController.increaseQuantity(medicine);
                                  },
                                  child: Padding(
                                    padding: const EdgeInsets.only(right: 6),
                                    child: Container(
            ...
            eshopController.totalAmount.value == 0.00
                ...
                : Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: LoaderButton(btnText: " Order", onTap: () async {}),
                  ),
            const SizedBox(
              height: 20,
            )
