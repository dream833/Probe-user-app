...
class TestCartModel {
  ...
  factory TestCartModel.fromRawJson(String str) =>
      TestCartModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory TestCartModel.fromJson(Map<String, dynamic> json) => TestCartModel(
