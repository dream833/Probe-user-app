...
class SSLCommerzPaymentView extends StatefulWidget {
  const SSLCommerzPaymentView({super.key});

  @override
  _SSLCommerzPaymentViewState createState() => _SSLCommerzPaymentViewState();
}
    ...
    Sslcommerz sslcommerz = Sslcommerz(
      initializer: SSLCommerzInitialization(
        ...
        sdkType: _radioSelected == SdkType.TESTBOX
            ? SSLCSdkType.TESTBOX
            : SSLCSdkType.LIVE,
        store_id: 'probe6577f936b399b',
        store_passwd: 'probe6577f936b399b@ssl',
        total_amount: 1.00,
        tran_id: "1",
      ),
    );
